...
function iniciar(id){
  ...
  url_intercom = opentok_api + 'token/create/' + session_id + '/intercom' + id + '/';
  token_intercom = getJSON(url_intercom);
  
  url_enfermagem = opentok_api + 'token/create/' + session_id + '/enfermagem' + id + '/';
  token_enfermagem = getJSON(url_enfermagem);

  url_commandcenter = opentok_api + 'token/create/' + session_id + '/commandcenter' + id + '/';
