...
function micSwitch(client, type, id){
  ...
  var cc_id = getCookie('my_id');
  mic_icon = document.getElementById(tag + id);
  topic_audio = client + '/' + type + '/' + id + '/audio';
  topic_commandcenter = client + '/commandcenter/' + cc_id + '/audio';
...
function speakerSwitch(client, type, id){
  ...
  //topic_audio = client + '/' + type + '/' + id + '/audio';
  topic_audio = client + '/intercom/' + id + '/audio';

  topic_commandcenter = 'cetam/commandcenter/' + cc_id + '/audio';
