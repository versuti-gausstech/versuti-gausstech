...
function micSwitch(client, type, id){
  ...
  if(mic_icon.classList.value == "bi bi-mic-mute-fill"){
    ...
    command = {'type' : 'mic', 'command' : 'on', 'message' : 'ligar'};
  }else{
    console.log("Fechando microfone");
    mic_icon.classList.value = "bi bi-mic-mute-fill";
    mic_icon.style.color = "red";
    command = {'type' : 'mic', 'command' : 'off', 'message' : 'desligar'};
  }
  sendJSONMessage(topic, command);
}
...
function speakerSwitch(client, type, id){
  ...
  if(speaker_icon.style.color == "red"){
    ...
    command = {'type' : 'speaker', 'command' : 'on', 'message' : 'ligar'};
  }else{
    console.log("Fechando speaker");
    speaker_icon.style.color = "red";
    command = {'type' : 'speaker', 'command' : 'off', 'message' : 'desligar'};
  }
  sendJSONMessage(topic, command);
}
