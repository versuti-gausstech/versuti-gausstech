...
function subscribeCommandCenter(session_obj, stream_obj){
  commandcenter_subscriber = session_obj.subscribe(stream_obj, 'subscriber', commandcenter_sub_options, handleError);
}

function unsubscribeCommandCenter(){
  session.unsubscribe(commandcenter_subscriber);
}
