        ...
        <table style="width:100%;">
          ...
          <tr>
            <td style="text-align: center; vertical-align: middle;">
              <div>
                <label class="switch">
                  <input type="checkbox" id="chkEnfermagem_enf-3" onclick="audioEnfermagem(getCookie('screen_3_enfermagem'))">
                  <span class="slider round"></span>
                </label>
              </div>
            </td>
            <td style="text-align: center; vertical-align: middle;">
              <i id="micEnfermagem_enf-3" style='font-size:50px;color:white;padding: 3px;' class="fas fa-microphone"></i>
              <i id="speakerEnfermagem_enf-3" style='font-size:50px;color:white;padding: 3px;' title="Audio da enfermagem mutado" class="fas fa-volume-mute" onclick="muteSpeaker('enfermagem',getCookie('screen_3_enfermagem'))"></i>
              <i id="audioEnfermagem_enf-3" style='font-size:50px;color:grey;padding: 3px;' title="Audio enfermagem offline" class="fas fa-user-nurse" onclick="chamarEnfermagem()"></i>
              <i id="bellEnfermagem_enf-3" style='font-size:50px;color:white;padding: 3px;' class="fas fa-bell" title="Enfermagem Chamando"> </i>
            </td>
          </tr>
        </table>
      </div>
